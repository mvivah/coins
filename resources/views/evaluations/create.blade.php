...
<!-- Add Custom content Section-->
    ...
    @section('content')
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/evaluations">Evaluations</a></li>
            <li class="breadcrumb-item active" aria-current="page">Create</li>
            </ol>
        </nav>
        <div class="py-3 bg-light">
                <div class="container-fluid">
                    <table id="evaluations_table" class="table table-striped">
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <strong>Intended Objectives</strong>
                                    </div>
                                    <div class="col-md-2">
            ...
            <form action="{{url('saveResponses')}}" method="POST" id="answersForm">
                @csrf
