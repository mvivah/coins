  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link active" href="/" id="show_dashboard">
            ...
            <ul class="nav flex-column mb-2">
                <li class="nav-item">
                    <a class="nav-link" href="/report_month"><span data-feather="file-text"></span> Current month</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/report_quarter"><span data-feather="file-text"></span> Last quarter</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/report_year"><span data-feather="upload-cloud"></span> Full year</a>
                </li>
                <li class="nav-item">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-3 mt-2">
            {{-- Notifications Area --}}
            <div class="row">
                <div class="col-md-3 offset-md-9 mb-0">
                    <div id="notices">
