...
class ServicelinesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $servicelines = [
            ...
            ['id' => 30,'beneficiary'=>'Administration','service_code'=>303, 'service_name' => 'Training', 'created_by' => $user],
            ['id' => 31,'beneficiary'=>'Administration','service_code'=>304, 'service_name' => 'Corporate Affairs- Legal', 'created_by' => $user],
            ['id' => 32,'beneficiary'=>'Administration','service_code'=>305, 'service_name' => 'Corporate Affairs- Human Resources', 'created_by' => $user],
            ['id' => 33,'beneficiary'=>'Administration','service_code'=>306, 'service_name' => 'Corporate Affairs- Finance', 'created_by' => $user],
            ['id' => 34,'beneficiary'=>'Administration','service_code'=>307, 'service_name' => 'Corporate Affairs- Administration', 'created_by' => $user],
            ['id' => 35,'beneficiary'=>'Administration','service_code'=>308, 'service_name' => 'Corporate Affairs- Management', 'created_by' => $user],
            ['id' => 36,'beneficiary'=>'Administration','service_code'=>309, 'service_name' => 'Corporate Affairs- IT Support', 'created_by' => $user],
            ['id' => 37,'beneficiary'=>'Administration','service_code'=>310, 'service_name' => 'No Work', 'created_by' => $user],
